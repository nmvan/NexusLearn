...
export const CourseOverview: React.FC<CourseOverviewProps> = ({ onContinue, hasPlan, onCreatePlan }) => {
  return (
    <div className="p-8 max-w-7xl mx-auto bg-slate-950 min-h-screen text-slate-50">
      <div className="flex items-center gap-4 mb-8">
        <div className="h-12 w-12 rounded-full bg-indigo-600 flex items-center justify-center text-white font-bold text-xl">
          NV
        </div>
        <div>
          <h1 className="text-2xl font-bold text-slate-100">Welcome back, Nhat Nguyen</h1>
          <p className="text-slate-400">Ready to master React today?</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-6">
          <h2 className="text-xl font-bold text-slate-100">Study Plan</h2>
          
          {!hasPlan ? (
             <div className="bg-slate-900 border border-slate-800 rounded-2xl p-8 text-center shadow-lg flex flex-col items-center justify-center min-h-[300px]">
               ...
               <button 
                 ...
                 className="bg-indigo-600 hover:bg-indigo-500 text-white font-bold py-3 px-6 rounded-xl transition-colors flex items-center gap-2 shadow-lg shadow-indigo-500/20"
               >
                 <Zap size={18} />
            ...
            <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 text-slate-100 shadow-lg flex flex-col md:flex-row gap-8">
            <div className="flex-shrink-0 flex flex-col items-center justify-center w-full md:w-1/3">
              <div className="relative w-40 h-40 flex items-center justify-center">
                ...
                <div className="w-32 h-32 rounded-full border-8 border-slate-800 flex items-center justify-center bg-slate-900 relative">
                  <div className="absolute inset-0 rounded-full border-8 border-indigo-500 border-t-transparent rotate-45"></div>
                  <span className="text-3xl font-bold text-indigo-400">75%</span>
                </div>
                <div className="absolute -bottom-2 bg-slate-800 px-3 py-1 rounded-full shadow-sm border border-slate-700 text-sm font-bold text-indigo-300">
                  React Mastery
                </div>
              </div>
            ...
            <div className="flex-grow space-y-6">
              ...
              <div>
                <div className="flex justify-between text-sm mb-2">
                  <span className="font-medium text-slate-300">Advanced Patterns Unlocked</span>
                </div>
              ...
              <p className="text-sm text-slate-300 bg-slate-800/50 border border-slate-700 p-3 rounded-lg">
